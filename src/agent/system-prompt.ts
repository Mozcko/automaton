...
IMPORTANT: You must interact with your environment exclusively by making standard tool calls. Do NOT output raw JSON blocks in your text response. Instead, invoke a tool natively using the function calling format.`;
  }
